...
<br>
 ...
 <br>                   <span>
  ...
  Veuillez entrer le code que vous avez reçu par mail (Code à utilisation temporaire inutilisable après 3 minutes )  <br>
  <br>
  <span style="color:red"><i class="ui icon warning circle"></i>CODE E-MAIL A UTILISATION TEMPORAIRE INUTILISABLE APRÈS 3 MIN, SI LE MESSAGE N'APPARAÎT PAS DANS VOTRE BOITE DE RÉCEPTION, VÉRIFIEZ DONC LE DOSSIER SPAM, INDÉSIRABLE</span>
                       </span> <br><br>
